...
bool CGUI::DrawWindow(CWindow* window)
{
	...
	if (TabCount) // If there are some tabs
	{
		...
		for (int i = 0; i < TabCount; i++)
		{
			...
			{
				Render::Clear(0 + (i*TabSize), 0, TabSize, MenuTopDown, Color(13, 218, 134, 255));
			}
...
void CGUI::SaveWindowState(CWindow* window, std::string Filename)
{
	...
	tinyxml2::XMLElement *Root = Doc.NewElement("beartrap");
	...
	{
		MessageBox(NULL, "Failed To Save Config File!", "beartrap", MB_OK);
	}
}
